...
from PySide6.QtWidgets import (QWidget, QVBoxLayout,
                                ...
                                QItemDelegate, QStyle, QProgressBar, QApplication)
...
class MovieList(QListWidget):
    ...
    def create_movies(self, files):
        ...
        self.movie_downloader.file_list = files
...
class DownloaderWorker(QThread):
    ...
    # a python nem tud valódi többszálaszítást - Thread
    # multiprocessing
    ...
    def run(self):
        ...
        for idx, file in enumerate(self.file_list):
            self.download_progress.emit({"progress_value": idx, "movie_file": f"dowloading: {os.path.basename(file)}"})
